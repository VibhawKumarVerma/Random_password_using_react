...
function App() {
  ...
  const copyPasswordToClipboard = useCallback(() => {
    ...
    // passwordRef.current?.setSelectionRange(0,3)  // This is used when we want to select only some characters onclicking.
  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-500">
      ...
      <div className="flex shadow rounded-lg overflow-hidden mb-4">
        ...
        <button onClick={copyPasswordToClipboard} className='outlint-none bg-blue-700 text-white px-3 py-0.5 shrink-0'>copy</button>
      </div>
